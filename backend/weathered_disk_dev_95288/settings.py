"""
Django settings for weathered_disk_dev_95288 project.
...
ROOT_URLCONF = 'weathered_disk_dev_95288.urls'
...
WSGI_APPLICATION = 'weathered_disk_dev_95288.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_disk_dev_95288 API",
    "DESCRIPTION": "API documentation for weathered_disk_dev_95288 App",
    "VERSION": "v1",
}
